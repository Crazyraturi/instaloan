  ...
  personal: [
    ...
    },
    {
      ...
      productBenefits: [
        ...
        "EMI moratorium options available",
        "Insurance coverage included",
        "Relationship pricing benefits",
        "Multi-city branch network support",
      ],
      whomToSale: [
        ...
        "Established customers with good relationship",
      ],
    },
    {
      amount: "₹ 3,00,000",
      ...
      age: "21 - 60 years",
      productBenefits: [
        "Accessible to moderate income groups",
      ...
      whomToSale: [
        ...
        "Family celebration expenses",
        "Appliance and gadget purchases",
        "Credit score improvement seekers",
      ],
    },
  ],
  business: [
    ...
    },
    {
      ...
      age: "3+ years",
      productBenefits: [
        "Large ticket business financing",
  ...
  emi: [
    ...
    },
    {
      ...
      whomToSale: [
        ...
        "Small-ticket purchase needs",
        "Budget-conscious customers",
        "First-time EMI card users",
        "Essential goods purchasers",
        "Local market shoppers",
        "Customers building credit history",
      ],
    },
  ],
  credit: [
    ...
    },
    {
      ...
      age: "21 - 65 years",
      productBenefits: [
        "Industry-leading rewards rate",
        "Multiple redemption options",
        "Special merchant partnerships",
      ...
      whomToSale: [
        "Reward-focused customers",
        "Brand loyalty seekers",
    ...
    },
    {
      ...
      productBenefits: [
        ...
        "Bill payment and utility rewards",
        "Investment and insurance linkage",
        "Family add-on cards",
        "Concierge and lifestyle services",
      ],
      whomToSale: [
        "Customers seeking all-in-one solution",
        "Family-oriented users",
        "Bill payment heavy customers",
        "Investment planning customers",
        "Convenience seekers",
        "Lifestyle service users",
...
// Initialize all loan cards when DOM is ready
document.addEventListener("DOMContentLoaded", function () {
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="d-flex justify-content-between mb-2">
                    ...
                    <span class="text-muted">${
                      card.age || "21 - 65 years"
                    }</span>
                  </div>
                  <div class="d-flex justify-content-between mb-2">
                    <span class="fw-medium">Min Income:</span>
                    <span class="text-muted">${
                      card.income || "25,000 & above"
                    }</span>
                  </div>
                </div>
              </div>
