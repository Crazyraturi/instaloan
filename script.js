...
const sampleData = {
  ...
  instant: [
    ...
    // leading plate
    {
      ...
      whomToSale: [
        "1.Age: 21- 60 Years",
        "2.CIBIL Score Above 600",
        "Monthly Income should be more than ₹20,000",
        "Available only for salaried individuals",
        "List of documents Required : KYC / Aadhar, Salary Bank Statements, Salary Slip and Residence Proof",
        "Work Email required Mandatory for Verification",
      ],
    },
    // bharat loan
    {
    ...
    // mpocket
    {
      ...
      productBenefits: [
        ...
        "⏱ Fast loan approval in 7 minutes, fund transfer to your bank account in 2 minutes",
        "Loan Amount Upto ₹20,000",
        "ROI From 24%",
      ],
      whomToSale: [
        "1. Available for students and salaried employees",
        "2. Available for New to Credit customer",
        "3. No credit score required",
        "4. Documents Required:",
        "(a) For students:",
        "- Valid College ID Card,",
        "- Voter Card/Driving License/ Passport/ Aadhar/ PAN Card",
        "(b) For salaried professionals:",
    ...
    // ramfincrop
    {
      ...
      whomToSale: [
        ...
        "- CIBIL Score 700+",
        "- NTC Allowed",
        "- Minimum 1 month Employer vintage",
        "- Min Net monthly income - INR 18,000 (Net take home)",
        "- Only for Salaried Person",
      ],
    },
    // lt  finance
